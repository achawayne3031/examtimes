            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-xl-6">
                        ...
                        <h5>Quiz name: <b><?php echo (!empty($data['resultDb']->quiz_name)) ? $data['resultDb']->quiz_name : "Quiz Not Found" ; ?></b></h5>
                                    ...
                                    <td>
                                        <?php 
                                            if($data['avaliable_ans']){ ?>
                                                ...
                                                <button class="btn btn-success" onclick="reTakeSubmitAnsByUsers()" id="submit-ans-user-btn">Submit</button>
